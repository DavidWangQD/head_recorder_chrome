...
function configNotice() {
    chrome.notifications.create('personal_config', {
        title: chrome.i18n.getMessage("configNoticeTitle"),
        message: chrome.i18n.getMessage("configNoticeMessage"),
        iconUrl: chrome.extension.getURL("icons/tom-60.png"),
        type: 'basic'
    });
}
...
function networkNotice() {
    ...
    chrome.notifications.create('personal_config', {
        title: chrome.i18n.getMessage("networkNoticeTitle"),
        message: chrome.i18n.getMessage("networkNoticeMessage")+"\n"+msg,
        iconUrl: chrome.extension.getURL("icons/tom-60.png"),
        type: 'basic'
    });
}